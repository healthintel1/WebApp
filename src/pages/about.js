					...
					<div className="grid-box1">
						<article class="w-100 Avenir shadow-4 hidden ba b--black-10">
						  ...
						  <div class="pl4 pb2 pt3 bt b--black-10">
						  	...
						  	<p className="ml3 mt4 body tj dark-gray">Use our site, put in your data to the best of your ability, and we will do our best to tell you how at risk you are for COVID-19 and how worried you should be</p>
						  </div>
						</article>
						<article class="w-100 Avenir shadow-4 hidden ba b--black-10">
