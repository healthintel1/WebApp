	...
	render() {
		return(
			<div className="shadow-3 tc b--light-gray ph5 pb4 bg-white ba" style={{margin:"auto", "font-family":"Avenir", width: "max(40%, 700px)"}}>
				...
				<p onClick={()=> navigate("/")} className="f4 tc no-underline black bg-animate hover-bg-purple hover-white inline-flex pointer mb3 items-center pa3 ba border-box" style={{"margin":"auto"}}>
				    <span> Sign In </span>
				</p>
			</div>
		);
